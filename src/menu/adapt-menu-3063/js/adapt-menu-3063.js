define(function(require) {
        ...
        Menu3063ItemView = MenuView.extend({
            ...
            className: function() {
                ...
                return [
                    ...
                    this.model.get('_isEnabled') != true ? 'menu-disabled' : 'menuNotDisable',
                    this.model.get('_isComplete') != true ? 'courseNotComplete' : 'courseCompleted',
                    'nth-child-' + nthChild,
            ...
            preRender: function() {
                ...
                if (completed > 0) {
					...
					var curID = this.model.get('_id').slice(3,5);
					
					
					/*if(ff == '05' && curID == '05'){
						_idNum = 2;
					}
					else if(ff == '10' && curID == '10'){
						alert('10');
						_idNum = 3;
					}
					else if(ff == '15' && curID == '15'){
						alert('15');
						_idNum = 4;
					}
					else if(ff == '20' && curID == '20'){
						alert('20');
						_idNum = 5;
					}
					else if(ff == '25' && curID == '25'){
						alert('25');
						_idNum = 6;
					}
					else if(ff == '30' && curID == '30'){
						alert('30');
						_idNum = 7;
					}
					else if(ff == '35' && curID == '35'){
						alert('35');
						_idNum = 8;
					}
					else if(ff == '40' && curID == '40'){
						alert('40');
						_idNum = 9;
					}
					else if(ff == '45' && curID == '45'){
						alert('45');
						_idNum = 10;
					}
					else if(ff == '50' && curID == '50'){
						alert('50');
            ...
            postRender: function() {
               ...
               setTimeout(function(){
					$(('.menu-item.menuNotDisable.courseNotComplete.nth-child-' +(_idNum)) + ' .page-level-progress-menu-item').addClass('abcd');
				}, 200);
    ...
    Adapt.on('router:menu', function(model) {
        ...
        $(".floatingmenu-inner").removeClass('show-floatingMenu');
        $(".floatingmenu-inner").addClass('hide-floatingMenu');
    ...
    Adapt.on('router:page', function(model) {
        var nums = model.get('_id').slice(3, 5);
        ...
        $(".floatingmenu-inner").removeClass('hide-floatingMenu');
        //$(".floatingmenu-inner").addClass('show-floatingMenu');
        for (var i = 1; i < 11; i++) {
            $(".floatingmenu-inner .menu" + i).removeClass("activePageStatus");
        ...
        if (!isComplete) {
            ...
            $(".menu"+(nums/5)).addClass("activePageStatus");
			ff = nums;
