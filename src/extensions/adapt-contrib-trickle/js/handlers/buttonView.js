define([
    ...
    var TrickleButtonView = Backbone.View.extend({
        ...
        onButtonClick: function() {
            ...
            $('._fButtondisable .trickle-button-inner.locking button').css('display', 'none')
			
			var storeClassess = this.model.get("_classes").split(" ")[0]
			if (storeClassess == "_hideGotoNextButon") 
			{
				 $('.custom_go-next .go-next-component .go-next-button').css('display', 'none');			
			}
